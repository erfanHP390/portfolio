                ...
                <div className="resume-h-content">
                  <div>
                    <div className="resume-h-c-title">
                      ...
                      <h4 className="resume-h-c-title-text">
                      تحصیلات 
                      </h4>
                    </div>
                    <ResumeContentBox date={`1401 - اکنون`}  style={`resume-h-c-box  orange`}  subtitle={`دانشگاه فرهنگیان`} title={`کارشناسی آموزش ابتدایی`} />
                  </div>
                  <div>
                    <div className="resume-h-c-title">
                      <div className="resume-h-c-title-icon">
              ...
              <div className="container resume-main">
                <div className="resume-main-container">
                  <div className="resume-m-c-right">
                    <h4 className="resume-m-c-right-title">
                    مهارت‌های کاری
                    </h4>
                    <HardSkill title={`HTML`}  percent={`88`}  color={`#dd4b25`} />
                    <HardSkill title={`CSS`}  percent={`93`}  color={`#264ADF`} />
                    <HardSkill title={`Bootstrap`}  percent={`98`}  color={`#8412F4`} />
                    <HardSkill title={`Tailwind`}  percent={`87`}  color={`#3bbef8`} />
                    <HardSkill title={`Sass`}  percent={`88`}  color={`#cc6699`} />
                    <HardSkill title={`Javascript`}  percent={`63`}  color={`#EFD81C`} />
                    ...
                    <HardSkill title={`UI/UX design`}  percent={`70`}  color={`#330057`} />
